  ...
  return (
    <div>
      ...
      <Card className="max-w-2xl shadow-sm">
        <Form layout="vertical" onFinish={onFinish} initialValues={{ status: CaseStatus.NEW, priority: CasePriority.MEDIUM }}>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Form.Item name="status" label="Status">
              <Select>
                {Object.values(CaseStatus).map(s => <Select.Option key={s} value={s}>{s}</Select.Option>)}
              </Select>
            </Form.Item>
          ...
          <div className="flex justify-end space-x-2 pt-4">
            ...
            <Button type="primary" htmlType="submit" loading={loading}>Save Case</Button>
          </div>
        </Form>
      </Card>
    </div>
